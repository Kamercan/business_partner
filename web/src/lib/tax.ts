/**
 * Vergi / kimlik numarası doğrulaması — sunucudaki `server/src/lib/tax.ts`
 * ile birebir aynı kuralları uygular. Buradaki kopya yalnızca kullanıcıya
 * anında geri bildirim vermek içindir; bağlayıcı denetim sunucudadır.
 *
